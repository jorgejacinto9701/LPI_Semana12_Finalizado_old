...
public class Validaciones {
	public static final String TEXTO = "[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{3,20}";
	...
	public static final String SALANUMERO = "[A-Z]{1}[0-9]{2}";	
	...
	public static final String SERIELIBRO = "\\d{5}";
	...
	public static final String NUMERO2 = "[0-9]{1,100}";
	public static final String SERIECRUDLIBRO= "[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{2,100}";
	
	public static final String NOMBRE ="[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{3,20}";
	public static final String PAIS ="[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{3,20}";
	public static final String GRAGO ="[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{5,25}";
	public static final String APELLIDOS ="[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{4,20}";
